...
- Switched Hyprland to 0.51.1 from Debian SID repo
    - Could not get 0.52.1 to work from source
    - SID was recently updated its pkgs to 0.51.
        - This speeds up installation
        - Updates to Hyprland will get installed via APT
        - Some Packages still build from source not in repo yet
        - Only Hyprland packages from from SID.
        - Debian Trixie, Forky, or SID are supported
    - Made build from source and option
